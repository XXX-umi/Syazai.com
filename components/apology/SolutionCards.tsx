    ...
    <div className="bg-white rounded-xl border border-zinc-200 overflow-hidden">
      <div className="p-4 border-b border-zinc-100 bg-blue-50">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-blue-900">二度とこのミスをしないために</h3>
        </div>
        <p className="text-xs text-zinc-600 mt-1">再発防止のためのおすすめツール</p>
      </div>
      ...
      <div className="p-4 space-y-3">
        {solutions.map((solution) => {
          ...
          return (
            <Card
              key={solution.id}
              className="group hover:shadow-md transition-all duration-200 cursor-pointer border-zinc-100 hover:border-blue-200"
            >
